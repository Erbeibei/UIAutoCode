...
class HomePage(Page, Browser):
    #   元素定位及实现
    username_loc = (By.XPATH, '//*[@id="app"]/div[6]/div/div/form/div[1]/input')
    password_loc = (By.XPATH, '//*[@id="app"]/div[6]/div/div/form/div[2]/input')
    sendCode_loc = (By.CLASS_NAME, 'send-code')
    inputCode_loc = (By.XPATH, '//*[@id="app"]/div[6]/div/div/form/div[3]/input')
